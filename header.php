...
<title>Chennai Institute of Technology</title>
        ...
        <div class="art-Sheet">
            ...
            <div class="art-Sheet-body">
                <div class="art-Header">
					...
					<img src="res/images/banner.jpg" width="900px" height="150px" alt="PostHeaderIcon" />
					</div>
                    <div class="art-Logo">
                      <!--  <h1 id="name-text" class="art-Logo-name"><a href="#">Heading</a></h1>
                        <div id="slogan-text" class="art-Logo-text">Visvak</div>-->
                    </div>
                </div>
                <div class="art-nav">
                	<div class="l"></div>
                	...
                	<ul class="art-menu">
						...
						<li><a href="forum.php" id="aforum"><span class="l" ></span><span class="r"></span><span class="t">Categories</span></a>
                			
                		<li><a href="contact.php" id="acontact"><span class="l"></span><span class="r"></span><span class="t">Contact</span></a></li>
                        
                        
							 <li><a href="uedit.php" id="amessage"><span class="l"></span><span class="r"></span><span class="t">Profile</span></a></li>
							<li><a href="question.php" id="amessage"><span class="l"></span><span class="r"></span><span class="t">Ask General Question</span></a></li>
