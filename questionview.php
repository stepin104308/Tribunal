...
$str="SELECT * from question, user where  user.user_id=question.user_id AND question_id=$_GET[qid]";
	...
	{	
		while($row = mysql_fetch_array($result))
		{
			...
			<tr>
			<td><img src='res/images/edit.jpg' class='imagedel'/> &nbsp <a href='answer.php?qid=$row[question_id]&id=$_GET[qid]' >REPLY</a><//td></tr>";
...
<?php
	...
	{	
		...
		while($row1 = mysql_fetch_array($result))
		{
			...
			echo "<span class='box2'>";
			echo "<span class='head'><a href='like.php?id=$row1[answer_id] ' class='view2' >Like $row1[like]</a> <a href='dwdpap.php?id=$_GET[qid]' class='view2'>Download</a>
</span>";
			...
			<tr><td> <img src='res/images/edit.jpg' class='imagedel'/> &nbsp <a href='answer.php?qid=$row[question_id]&id=$_GET[qid]' >REPLY</a></td></tr>
